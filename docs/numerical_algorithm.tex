...
2 (\Delta_{2,+} + \Delta_{2,-})^{-1} \Delta_{2,-}^{-1} &-2\Delta_{2,-}^{-1} \Delta_{2,+}^{-1}  & 2 (\Delta_{2,+} + \Delta_{2,-})^{-1} \Delta_{2,+}^{-1}  &\dots&0&0&0\\
\vdots&\vdots&\vdots&\ddots&\vdots&\vdots&\vdots\\
0&0&0&\dots&2(\Delta_{P-1,+}+\Delta_{P-1,-})^{-1} \Delta_{P-1,-}^{-1} &-2\Delta_{P-1,-}^{-1} \Delta_{P-1,+}^{-1}  & 2 (\Delta_{P-1,+}+\Delta_{P-1,-})^{-1} \Delta_{P-1,+}^{-1} \\
