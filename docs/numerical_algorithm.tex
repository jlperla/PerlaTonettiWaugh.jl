...
\begin{align}
	\D[t]\tilde{v}(z,t) &= \underbrace{\left(\left(r - g(t)- \xi(\gamma-g(t)) - \frac{\sigma^2}{2}\xi^2\right) - (\gamma + \sigma^2\xi - g(t)) \D[z] - \tfrac{\sigma^2}{2} \D[zz]\right)}_{\equiv \tilde{A}(t)} - \tilde{\pi}(z,t) \label{eq:bellman-GBM-dynamic-normalized-rearranged}\\
...
\begin{align}
A(t) &\equiv \left(r - g(t)- \xi(\gamma-g(t)) - \frac{\sigma^2}{2}\xi^2\right) I - (\gamma + \sigma^2\xi - g(t)) L^{-}_1 - \tfrac{\sigma^2}{2} L_2\label{eq:A-def-simple}
\end{align}
