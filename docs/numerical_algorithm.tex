...
\begin{itemize}
	...
	\end{align}
	with $\Delta_1 \equiv  \Delta_{1,+}$, $\Delta_P \equiv  \Delta_{P,-}$.
...
Note that we have assumed that $\Delta_{i-1} = \Delta_{i,+}$ and $\Delta_{P,+} = \Delta_{P,-}$ for the ghost notes. Using discretized central differences of second orders, \eqref{eq:new-BC1} can be shown as
\begin{align}
...
2\Delta_{2,-}^{-1} \Delta_{2}^{-1}&-2\Delta_{2,-}^{-1} \Delta_{2,+}^{-1}  & 2\Delta_{2,+}^{-1} \Delta_{2}^{-1} &\dots&0&0&0\\
\vdots&\vdots&\vdots&\ddots&\vdots&\vdots&\vdots\\
0&0&0&\dots&2\Delta_{P-1,-}^{-1} \Delta_{P-1}^{-1}&-2\Delta_{P-1,-}^{-1} \Delta_{P-1,+}^{-1}  & 2 \Delta_{P-1,+}^{-1} \Delta_{P-1}^{-1}\\
