...
@test_broken results_algebraic.g ≈ 0.020727753490265812; # from updating the eq in stationary
@test_broken results_algebraic.ν ≈ 1.797254207263066;
@test_broken results_algebraic.v(0) ≈ 34.58676260411018;
@test_broken results_algebraic.v(2)*exp(2) ≈ 164.54095232228548; # correct for rescaling
